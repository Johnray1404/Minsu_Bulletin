...
<div class="main-content">
    ...
    <form action="/admin/post_news" method="POST" enctype="multipart/form-data" class="news-form">
        ...
        <div class="form-group">
            ...
            <textarea id="content" name="content" placeholder="Enter the content of the news" rows="5" required></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="caption" name="caption" placeholder="Enter a caption for the image" required>
        </div>
